...
export declare class DatasetAP implements Dataset {
    ...
    constructor(data: Array<number[]>, target: Array<number[]>, featureNames: string[], targetNames: string[], description: string, locRecordName: string, locRecordVersion: string, locPreprocessName: string, locPreprocessVersion: string, annotatorName: string, annotatorVersion: string, quantifierName: string, quantifierVersion: string, preprocessorName: string, preprocessorVersion: string);
}
